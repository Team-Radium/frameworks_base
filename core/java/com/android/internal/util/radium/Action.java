...
public class Action {
    ...
    public static void processActionWithOptions(Context context,
            ...
            if (action == null || action.equals(RadiumActionConstants.ACTION_NULL)) {
                return;
            }
            ...
            if (action.equals(RadiumActionConstants.ACTION_HOME)) {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_BACK)) {
                triggerVirtualKeypress(KeyEvent.KEYCODE_BACK, isLongpress);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_SEARCH)) {
                triggerVirtualKeypress(KeyEvent.KEYCODE_SEARCH, isLongpress);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_MENU)
                    || action.equals(RadiumActionConstants.ACTION_MENU_BIG)) {
                triggerVirtualKeypress(KeyEvent.KEYCODE_MENU, isLongpress);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_POWER_MENU)) {
                try {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_IME_NAVIGATION_LEFT)) {
                triggerVirtualKeypress(KeyEvent.KEYCODE_DPAD_LEFT, isLongpress);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_IME_NAVIGATION_RIGHT)) {
                triggerVirtualKeypress(KeyEvent.KEYCODE_DPAD_RIGHT, isLongpress);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_IME_NAVIGATION_UP)) {
                triggerVirtualKeypress(KeyEvent.KEYCODE_DPAD_UP, isLongpress);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_IME_NAVIGATION_DOWN)) {
                triggerVirtualKeypress(KeyEvent.KEYCODE_DPAD_DOWN, isLongpress);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_POWER)) {
                PowerManager pm = (PowerManager) context.getSystemService(Context.POWER_SERVICE);
                pm.goToSleep(SystemClock.uptimeMillis());
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_KILL)) {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_LAST_APP)) {
                if (isKeyguardShowing) {
                    return;
                }
                try {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_RECENTS)) {
                if (isKeyguardShowing) {
                    return;
                }
                try {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_IME)) {
                if (isKeyguardShowing) {
                    return;
                }
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_ASSIST)
                    || action.equals(RadiumActionConstants.ACTION_KEYGUARD_SEARCH)) {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_VOICE_SEARCH)) {
                ...
                try {
                    ...
                    Log.e("RadiumActions:", "No activity to handle assist long press action.", e);
                }
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_VIB)) {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_SILENT)) {
                AudioManager am = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
                if (am != null && ActivityManagerNative.isSystemReady()) {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_VIB_SILENT)) {
                AudioManager am = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
                if (am != null && ActivityManagerNative.isSystemReady()) {
                ...
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_CAMERA)) {
                ...
                startActivity(context, intent, barService, isKeyguardShowing);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_MEDIA_PREVIOUS)) {
                dispatchMediaKeyWithWakeLock(KeyEvent.KEYCODE_MEDIA_PREVIOUS, context);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_MEDIA_NEXT)) {
                dispatchMediaKeyWithWakeLock(KeyEvent.KEYCODE_MEDIA_NEXT, context);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_MEDIA_PLAY_PAUSE)) {
                dispatchMediaKeyWithWakeLock(KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE, context);
                return;
            } else if (action.equals(RadiumActionConstants.ACTION_WAKE_DEVICE)) {
                ...
                try {
                    ...
                    Log.e("RadiumActions:", "URISyntaxException: [" + action + "]");
                    return;
                }
                startActivity(context, intent, barService, isKeyguardShowing);
                return;
    ...
    public static boolean isActionKeyEvent(String action) {
        if (action.equals(RadiumActionConstants.ACTION_HOME)
                || action.equals(RadiumActionConstants.ACTION_BACK)
                || action.equals(RadiumActionConstants.ACTION_SEARCH)
                || action.equals(RadiumActionConstants.ACTION_MENU)
                || action.equals(RadiumActionConstants.ACTION_MENU_BIG)
                || action.equals(RadiumActionConstants.ACTION_NULL)) {
            return true;
        }
        return false;
    }
